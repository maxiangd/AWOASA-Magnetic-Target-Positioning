...
| F12 | Penalized 1 | n | [-50, 50] | \( f(x) = \frac{\pi}{n} \left\{ 10\sin^2(\pi y_1) + \sum_{i=1}^{n-1} (y_i-1)^2[1+10\sin^2(\pi y_{i+1})] + (y_n-1)^2 \right\} + \sum_{i=1}^n u(x_i,10,100,4) \) <br> \( y_i = 1 + \frac{x_i+1}{4} \) | 0 |
