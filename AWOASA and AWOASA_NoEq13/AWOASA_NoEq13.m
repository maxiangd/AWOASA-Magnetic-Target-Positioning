function [Leader_score,Leader_pos,Convergence_curve]=AWOASA_NoEq13(SearchAgents_no,Max_iter,lb,ub,dim,fobj)
...
% Calculate initial fitness values for SA
...
while t<Max_iter
    ...
    % Generate new candidate positions for SA
